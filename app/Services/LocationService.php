...
class LocationService
{
    ...
    public function requestLocations(User $admin, ?array $employeeIds = null): LocationRequest
    {
        return DB::transaction(function () use ($admin, $employeeIds): LocationRequest {
            ...
            $this->fcmService->sendLocationRequestedNotification($targetEmployeeIds, $locationRequest->id);
